...
public class PokemonTest {
    public static void main(String args[]) throws Exception {
        ...
        for(int i=0; i<N ; i++){
           ...
           //แก้แค่บรรทัดนี้ *****************************ตอนสอบน่ะนะ
           Pokemon pkm  = new Pokemon(pokemon_name_english,pokemon_name_chinese
                   ,pokemon_base_hp,pokemon_base_attack,pokemon_base_defense, pokemon_base_speed );
